...
| :--- | :--- | :--- | :--- |
| **Introduction to Phishing** | Brand Impersonation, Bitly Redirects, Typo-Squatting | Egress Firewall Logs, Sandbox, SIEM | [View Incident Report](thm-introduction-to-phishing) |
