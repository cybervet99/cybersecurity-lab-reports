...
| **Exploiting Vulnerable Workstation** | Unauthenticated Backdoor (vsftpd v2.3.4), EOL Service Exploitation | Zenmap, Tenable Nessus, Metasploit Framework, iptables | [View Lab Report](./penetration-testing-vulnerable-workstationREADME.md) |
